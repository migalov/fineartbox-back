...
export interface ApiConstructionTypeConstructionType
  extends Struct.CollectionTypeSchema {
  collectionName: 'construction_types';
  info: {
    displayName: 'Construction Type';
    pluralName: 'construction-types';
    singularName: 'construction-type';
  };
  options: {
...
export interface ApiConstructionConstruction
  extends Struct.CollectionTypeSchema {
...
export interface ApiPackageTypePackageType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    constructionTypes: Schema.Attribute.Relation<
      'oneToMany',
      'api::construction-type.construction-type'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    lodgements: Schema.Attribute.Relation<
      'manyToMany',
      'api::lodgement.lodgement'
    >;
